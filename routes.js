...
router.post("/fulfillment_created_webhook", async function (req, res) {
  const payload = req.body;
  console.log("created_order_id", payload.order_id);
  if (
    !(
...
router.post("/fulfillment_updated_webhook", async function (req, res) {
  const payload = req.body;
